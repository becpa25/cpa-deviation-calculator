...
export default function Home() {
  ...
  const [statsDataMode, setStatsDataMode] = useState<string>('actual');
...
const handleStatsDataModeChange = (mode: string) => {
  ...
  const generateStatsWithMode = (mode: string) => {
  return Object.keys(questionConfig).map(key => {
    ...
    if (mode === 'actual') {
      ...
      // エントロピー重み付け基準
      const multiplier = parseFloat(mode.replace('x', ''));
      const mu0 = average / multiplier;
      const sigma0 = stdDev / multiplier;
      const score52Level = mu0 + 0.2 * sigma0;
      ...
      <div className="container mx-auto max-w-4xl p-5">
        ...
        <div className="text-center mb-5">
          <button
            ...
            className={`mx-2 px-6 py-3 rounded-full text-white font-semibold transition-all ${currentMode === 'input'
          ...
          <button
            ...
            className={`mx-2 px-6 py-3 rounded-full text-white font-semibold transition-all ${currentMode === 'stats'
              ...
              <div className="mb-6">
                <div className="flex flex-wrap justify-center gap-1 bg-gray-100 p-2 rounded-lg">
                  <button
                    ...
                    className={`px-3 py-2 rounded-md font-medium text-xs sm:text-sm transition-all ${dataMode === 'actual'
                  ...
                  <button
                    ...
                    className={`px-3 py-2 rounded-md font-medium text-xs sm:text-sm transition-all ${dataMode === '1.2x'
                  ...
                  <button
                    ...
                    className={`px-3 py-2 rounded-md font-medium text-xs sm:text-sm transition-all ${dataMode === '1.3x'
                  ...
                  <button
                    ...
                    className={`px-3 py-2 rounded-md font-medium text-xs sm:text-sm transition-all ${dataMode === '1.4x'
                  ...
                  <button
                    ...
                    className={`px-3 py-2 rounded-md font-medium text-xs sm:text-sm transition-all ${dataMode === '1.5x'
  ...
  <div className="p-6">
    ...
    <div className="mb-6">
      <div className="flex flex-wrap justify-center gap-1 bg-gray-100 p-2 rounded-lg">
        ...
        <button
          onClick={() => handleStatsDataModeChange('1.2x')}
          className={`px-3 py-2 rounded-md font-medium text-xs sm:text-sm transition-all ${
            statsDataMode === '1.2x'
              ? 'bg-green-600 text-white shadow-md'
              : 'text-gray-600 hover:text-gray-800'
        ...
        <button
          onClick={() => handleStatsDataModeChange('1.3x')}
          className={`px-3 py-2 rounded-md font-medium text-xs sm:text-sm transition-all ${
            statsDataMode === '1.3x'
              ? 'bg-yellow-600 text-white shadow-md'
              : 'text-gray-600 hover:text-gray-800'
        ...
        <button
          onClick={() => handleStatsDataModeChange('1.4x')}
          className={`px-3 py-2 rounded-md font-medium text-xs sm:text-sm transition-all ${
            statsDataMode === '1.4x'
              ? 'bg-orange-600 text-white shadow-md'
              : 'text-gray-600 hover:text-gray-800'
        ...
        <button
          onClick={() => handleStatsDataModeChange('1.5x')}
          className={`px-3 py-2 rounded-md font-medium text-xs sm:text-sm transition-all ${
            statsDataMode === '1.5x'
              ? 'bg-purple-600 text-white shadow-md'
              : 'text-gray-600 hover:text-gray-800'
    ...
    <div className="mb-6 p-3 rounded-lg text-sm text-center">
      {statsDataMode === 'actual' && (
        <div className="bg-blue-50 text-blue-800 border border-blue-200">
          現在入力されている実データに基づく統計です
        </div>
      )}
      {statsDataMode === '1.2x' && (
        <div className="bg-green-50 text-green-800 border border-green-200">
          入力者平均の83%水準（1/1.2倍）に基づく統計です
        </div>
      )}
      {statsDataMode === '1.3x' && (
        <div className="bg-yellow-50 text-yellow-800 border border-yellow-200">
          入力者平均の77%水準（1/1.3倍）に基づく統計です
        </div>
      )}
      {statsDataMode === '1.4x' && (
        <div className="bg-orange-50 text-orange-800 border border-orange-200">
          入力者平均の71%水準（1/1.4倍）に基づく統計です
        </div>
      )}
      {statsDataMode === '1.5x' && (
        <div className="bg-purple-50 text-purple-800 border border-purple-200">
          入力者平均の67%水準（1/1.5倍）に基づく統計です
        </div>
      )}
    </div>
    ...
    <div className="overflow-x-auto">
      <table className="w-full border-collapse min-w-max">
        ...
        <tbody>
          {generateStatsWithMode(statsDataMode).map((stat, index) => (
